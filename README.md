This is a simple bash script that i made to quickly find ip address from shodan for free i used facet analysis to grep all the ip's and all hope you like it :)
